...
class BruteForceWordle:
    def __init__(self, wordleGame: WordleGame):
        ...
        self.possibleWords = self.game.getDicionario()
    ...
    def best_guess(self):
        ...
        dicionario = self.game.getDicionario().get_words()
...
# DESCOBRI FUNCAO QUE DESCOBRE SE CHARACTER TEM APENAS UMA POSICAO POSSIVEL E CONVERTER PARA INT
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!